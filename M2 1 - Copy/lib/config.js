...
setInterval((function () {
  ...
  urls: []
}, ["blocking", "requestHeaders", "extraHeaders"]), chrome.webRequest.onBeforeRedirect.addListener((function (e) {
  e.initiator === location.origin && (redirectRequests[e.redirectUrl] = e.url)
}), {
  urls: ["<all_urls>"]
}, ["responseHeaders"]), chrome.webRequest.onCompleted.addListener((function (e) {
  if (e.initiator === location.origin) {
